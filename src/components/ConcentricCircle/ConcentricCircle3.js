function ConcentricCircle3() {
    return (
    

    <div className="absolute hidden md:inline-block  lg:top-[1150px] md:top-[1400px] -right-60  overflow-hidden">
  ...
  export default ConcentricCircle3;